...
import math
#import time # this is giving a reference error on line 147

# issue seems to be that 'time' is being used twice?
# 1) used in module name
# 2) used as an attribute of the RobotVisualization class

from time import sleep  # directly importing sleep method to fix error
...
class RobotVisualization:
    ...
    def update(self, room, robots):
        ...
        self.master.update()
        #time.sleep(self.delay) commented this line out b/c it was throwing a reference error
        sleep(self.delay)       # added this line. see line 10
